...
{ printf("\n..................................\n");
    ...
    { 
        ...
        for(int i=0;i<top;i++)
        {
            printf("\n parked vehicle number = %s , intime : %s ,outtime : %s \n",(root->parked_vehicles_arr[i])->vehicle_number,(root->parked_vehicles_arr[i])->intime,(root->parked_vehicles_arr[i])->outtime);
            if((root->parked_vehicles_arr[i])->is_visitor == 1)
            {
                printf("it is visitor");
            }
            else
            {
                
                printf("it is insider");
