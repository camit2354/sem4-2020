...
while(fscanf(fp, "%d %d %d %d\n",&wing_id,&flat_id,&no_of_two_wheelers,&no_of_four_wheelers)!=EOF  )
{   flat_info_type *newNode =(flat_info_type *)malloc(sizeof(flat_info_type));
    ...
    fgets(vehicle_number[0],9,fp);
   strcpy(newNode->vehicle_number[0],vehicle_number[0]);


         fgets(vehicle_number[1],9,fp);
        strcpy(newNode->vehicle_number[1],vehicle_number[1]);

    // for(int k=0;k<no_of_two_wheelers;k++)
    // {
    //     fgets(vehicle_number[k],9,fp);
    //     strcpy(newNode->vehicle_number[k],vehicle_number[k]);
    // }

    // for(int k=0;k<no_of_four_wheelers;k++)
    // {
    //      fgets(vehicle_number[k+no_of_two_wheelers],9,fp);
    //     strcpy(newNode->vehicle_number[k+no_of_two_wheelers],vehicle_number[k+no_of_two_wheelers]);
    // }
    // printf("\n vehicle number 1=%s \t vehicle number 2=%s",vehicle_number[0],vehicle_number[1]);
   printf("%d %d %d %d %s %s",wing_id,flat_id,no_of_two_wheelers,no_of_four_wheelers,vehicle_number[0],vehicle_number[1]);
