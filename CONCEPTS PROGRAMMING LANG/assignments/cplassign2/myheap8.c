...
{    
    freeptr=makefreeNode(1024*sizeof(char),8000);
    return freeptr;
}
...
{      
     ...
     traversefreell(freepptr);
    printf("modified free linked list is \n ");
     updatefreell(freepptr);
      traversefreell(freepptr); 

}

/*........................function : updatefreell() ................*/
 void updatefreell(freeNode **freepptr)
 {   printf("hi ,i am in updatefreell function \n");
     freeNode *ptr1=*freepptr,*ptr2=(*freepptr)->next,*nptr=NULL;
     while(ptr2!=NULL)
     {
         if((ptr1->size==ptr2->size)&&(ptr2->location==(ptr1->location+ptr1->size)))
         {
              nptr=makefreeNode((ptr1->size)*2,ptr1->location);
              printf("new node data : %d %d",nptr->location,nptr->size);
              nptr->next=ptr2->next;
            /*  free(ptr1);
              free(ptr2);  */
              ptr1=nptr;
