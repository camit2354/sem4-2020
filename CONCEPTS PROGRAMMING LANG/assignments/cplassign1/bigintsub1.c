...
{  printf("\n........ i am in function addTwoneg  .....\n");
    ...
    b->s[b->size]='\0';
      printf("%s \n",b->s);
    printf("\n........ i am in end of function addTwoneg  .....\n");
    return b;
}

bigint *addfirstneg(bigint b1,bigint b2)
{  printf("\n........ i am in function addFirstNeg  .....\n");
    bigint *b=(bigint *)malloc(sizeof(bigint));
    b->size=b1.size;
